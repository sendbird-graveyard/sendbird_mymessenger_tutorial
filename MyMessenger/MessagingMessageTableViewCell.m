...
- (CGFloat) getCellHeight
{
    ...
    return 8 + nicknameRect.size.height + messageRect.size.height + self.messageContainerBottomPadding.constant + self.messageContainerTopPadding.constant + self.nicknameMessageContainerGap.constant + 4;
}
